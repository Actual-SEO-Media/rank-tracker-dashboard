...
<!-- Navigation -->
 <div class="flex justify-between mb-6">
  ...
  <div class="flex gap-4">
    <a href="<?php echo SITE_URL; ?>/positions/<?php echo $report['report_id']; ?>" class="inline-flex items-center px-4 py-2 rounded-md bg-white border border-slate-200 shadow-sm text-slate-700 hover:bg-slate-50 transition-colors">
    ...
    <a href="<?php echo SITE_URL; ?>/keywords/<?php echo $report['report_id']; ?>" class="inline-flex items-center px-3 py-1.5 text-medium rounded-md bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 transition-colors">
      Keywords
    </a>
    <a href="<?php echo SITE_URL; ?>" class="inline-flex items-center px-3 py-1.5 text-medium rounded-md bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 transition-colors">
      Baseline Report
    </a>
     <a href="<?php echo SITE_URL; ?>" class="inline-flex items-center px-3 py-1.5 text-medium rounded-md bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 transition-colors">
      Summary
  ...
  <div class="flex gap-4">
    ...
    <div class="flex rounded-lg border border-slate-200 overflow-hidden">
      <a href="<?php echo $navigation['prev_report_id'] ? SITE_URL . '/view_report/' . $navigation['prev_report_id'] : '#'; ?>"
    ...
    <?php echo date('M Y', strtotime($period . '-01')); ?>
      ...
      <a href="<?php echo $navigation['next_report_id'] ? SITE_URL . '/view_report/' . $navigation['next_report_id'] : '#'; ?>"
    ...
    <a href="<?php echo SITE_URL; ?>/import/<?php echo urlencode($report['client_domain']); ?>" class="inline-flex items-center px-4 py-2 rounded-md bg-white border border-slate-200 shadow-sm text-slate-700 hover:bg-slate-50 transition-colors">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-slate-500" viewBox="0 0 20 20" fill="currentColor">
