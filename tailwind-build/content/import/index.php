...
<div class="mb-4">
  <a href="<?php echo SITE_URL; ?>" class="text-slate-900 hover:text-slate-700 flex items-center">
...
<div class="bg-white rounded-lg border border-slate-200 shadow-sm p-6">
  ...
  <form action="<?php echo SITE_URL; ?>/import" method="post" enctype="multipart/form-data" class="space-y-4">
    <div>
