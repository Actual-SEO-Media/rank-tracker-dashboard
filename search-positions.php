...
// Page title
$page_title = "Search Positions: " . formatReportPeriod($report['report_period']);
...
<div class="flex items-center mb-6">
    <a href="report-details.php?id=<?php echo $report_id; ?>" class="bg-white rounded-md p-2 mr-2 hover:bg-gray-100">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
        </svg>
    </a>
    <h1 class="text-2xl font-bold text-gray-800">
        Search Positions - <?php echo formatReportPeriod($report['report_period']); ?>
    </h1>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        ...
        sortTable('mobile-table', 1);
        sortTable('yahoo-table', 1);
        sortTable('bing-table', 1);
    }, 100);
});
