...
<div class="bg-white rounded-lg shadow-md p-6 mb-6">
    ...
    <div id="tabContent">
                    ...
                    <table id="google-table" class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Visibility</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php foreach ($google_data as $row): ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-2 whitespace-nowrap"><?php echo $row['visibility']; ?>%</td>
        ...
        <!-- Similar tabs for Google Mobile, Yahoo, Bing -->
        <!-- ... (similar structure to the Google tab, but with different data) ... -->
    </div>
</div>
