...
<div class="container mx-auto px-4 py-6">
  ...
  <div class="flex justify-between items-center mb-6">
      ...
      <a href="index.php?action=import" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md flex items-center transition-colors">
                      ...
                      <?php foreach ($clients as $client): ?>
                          <tr class="hover:bg-gray-50 transition-colors">
                              ...
                              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                  <a href="index.php?action=reports&domain=<?php echo urlencode($client['domain']); ?>" class="text-blue-600 hover:text-blue-900 mr-3 transition-colors">
                                      View Reports
                                  </a>
                                  <a href="index.php?action=import&domain=<?php echo urlencode($client['domain']); ?>" class="text-green-600 hover:text-green-900 transition-colors">
                                      Import New
                                  </a>
                              </td>
                          </tr>
