  ...
  <header class="bg-slate-900 relative z-10 print-hidden">
    <div class="container mx-auto px-4">
      <div class="flex justify-between items-center h-16">
        <div class="flex items-center">
          <a href="<?php echo $_ENV['SITE_URL']; ?>" class="flex items-center space-x-2">
    ...
    <div class="hidden md:hidden" id="mobile-menu">
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-slate-900">
        <a href="<?php echo $_ENV['SITE_URL']; ?>" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-slate-800">
          Clients
        </a>
        <a href="<?php echo $_ENV['SITE_URL']; ?>/import" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-slate-800">
          Import Data
        </a>
      </div>
    </div>
