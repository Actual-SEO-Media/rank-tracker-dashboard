...
<div class="container mx-auto px-4 py-6">
  ...
  <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <a href="<?php echo $_ENV['SITE_URL']; ?>/import" class="border border-gray-200 rounded-lg p-4 hover:bg-blue-50 transition-colors flex items-center group">
                ...
                <?php foreach ($clients as $client): ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="<?php echo $_ENV['SITE_URL']; ?>/reports/<?php echo urlencode($client['domain']); ?>" 
                            ...
                            <a href="<?php echo $_ENV['SITE_URL']; ?>/import/<?php echo urlencode($client['domain']); ?>" 
